...
return {
    anim_dict = wrapper(request_anim_dict, native.remove_anim_dict, native.has_anim_dict_loaded, native.does_anim_dict_exist),
    model = wrapper(request_model, native.set_model_as_no_longer_needed, native.has_model_loaded, native.is_model_valid),
    anim_set = wrapper(request_anim_set, native.remove_anim_set, native.has_anim_set_loaded),
    streamed_texture_dict = wrapper(request_streamed_texture_dict, native.set_streamed_texture_dict_as_no_longer_needed, native.has_streamed_texture_dict_loaded),
    named_ptfx_asset = wrapper(request_named_ptfx_asset, native.remove_named_ptfx_asset, native.has_named_ptfx_asset_loaded),
    scaleform_movie = wrapper(request_scaleform_movie, native.set_scaleform_movie_as_no_longer_needed, native.has_scaleform_movie_loaded),
    weapon_asset = wrapper(request_weapon_asset, native.remove_weapon_asset, native.has_weapon_asset_loaded),
}
